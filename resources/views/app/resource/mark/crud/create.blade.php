...
@section('contents')
    <div class="w-100 flex justify-center">
        <div class="w-full p-4 bg-white shadow">
            <div class="w-full block flex justify-between items-center mb-5 border-gray-200">
                <p class="text-xl text-gray-600 font-thin">Register New Student</p>
                {{-- <a href="{{route('students.index')}}">
                    <x-form.button color='red' label='Done' />
                </a> --}}
            </div>
