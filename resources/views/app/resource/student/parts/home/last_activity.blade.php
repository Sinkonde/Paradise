...
<div class="w-full rounded-lg py-4 px-4 flex flex-col shadow-lg border mb-5 bg-white">
    ...
    @endif
    <a href="{{route('students.show',['student'=>$student->id, 'link'=>'t'])}}" class="text-xs mt-2 md:mt-3 md:text-xs text-blue-500 md:text-blue-300 md:hover:text-blue-500 font-semibold md:font-thin">View all activities >></a>
</div>
@endsection
