...
<div style="text-align:center">
    ...
    <p class="font-semibold" style="font-size:12px; padding-bottom:3px; margin:0px; line-height:;font-weight:300">{{env('APP_NAME')}}</p>
    <p style="font-size:14px; margin:0px;">{{env('APP_DESC')}}</p>
